...
- Collects biological/behavioural signals from **wearable sensor nodes** (e.g., accelerometer/IMU, temperature).
...
- Trains ML models (e.g., XGBoost) to classify behaviours and support anomaly detection.
